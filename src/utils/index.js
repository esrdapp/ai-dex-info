...
export const urls = {
  showTransaction: (tx) => `https://hscan.org/tx/${tx}/`,
  showAddress: (address) => `https://hscan.org/address/${address}/`,
  showToken: (address) => `https://hscan.org/token/${address}/`,
  showBlock: (block) => `https://hscan.org/block/${block}/`,
}
